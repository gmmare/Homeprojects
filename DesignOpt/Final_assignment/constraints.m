function [p_max] = constraints(xdes)
...
% [displacements | velocities | aerodynamic states]. 
...
%aerodynamic settings at flight conditions
V = 32.65; %reference flutter speed
rho = 0.0889; 
q = 0.5 * rho * V^2;
...
%getting maximum real part of eigenvalue
p_max = max(real(D));
